...
public class Application02 {
    public static void main(String[] args) {
        ...
        * 참조 자료형(referenece type)이라고 한다*/
        iarr = new int[5];
        darr = new double[10];
         //대괄호 안의 숫자는 비워두면 안됨. 할당할 크기는 반드시 지정되어야 함
      ...
      //  System.out.println("darr : " + darr);
        ...
        /*hashCode() : 객체의 주소값을 10진수로 변환하여 생성한 객체의 고유한 정수 값을 반환하는 메소드*/
      ...
      //  System.out.println("arr의 hashCode : " + arr.hashCode());
       ...
       // System.out.println("arr의 hashCode : " + arr.hashCode());
       // System.out.println("arr의 길이 : " + arr.length);
        //기존의 heap 영역은 시간이 지나도 참조되지 않되기 때문에 가비지콜랙터에 의해 사라짐
        //개발자가 직접 지우긴 힘듦

        /*한 번 할당 된 배열은 지울 수 없다
        * 단, 참조되지 않는 배열은 일정 시간이 지난 후 heap의 old 영역으로 이동하여
        * GC(가비지 콜랙터)가 삭제시킨다
        * 한 번 찾아갈 수 있는 주소값을 잃어버린 배열은 다시 참조 불가능하다
        * arr = null ; 참조하는 주소값이 없음을 나타냄*/

        arr = null ;

        /* java.lang.NullPointerExceoption 발생
